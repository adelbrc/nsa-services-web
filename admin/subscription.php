			...
			<table class="table table-striped">
			  ...
			  <tbody>
				...
				<tr>
				  ...
				  <td><button type="button" id="deleteSub" onclick="supprimer(this, <?php echo $result['id']; ?>)"  class="close" aria-label="Close" href="#"><span aria-hidden="true">&times;</span></button></td>
